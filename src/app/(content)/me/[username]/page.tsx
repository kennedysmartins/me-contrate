...
export default function mePage({ params: { username } }: Params) {
  return (
    <div className="w-full min-h-full h-[calc(100vh)] flex md:items-center md:justify-center bg-black/[0.93] antialiased bg-grid-white/[0.1] relative overflow-hidden">
