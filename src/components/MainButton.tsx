...
const MainButton: React.FC<ButtonProps> = ({ move = false, title, github, linkedin }) => {
  ...
  return (
    <>
      ...
      >
        <div
          className="relative inline-flex items-center justify-center p-4 px-8 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500 z-40"
        >
      ...
      {showModal && <Modal  github={github} linkedin={linkedin} closeModal={handleModalClose} />}
    </>
  );
};
