...
const MainButton2: React.FC<ButtonProps> = ({
  ...
  return (
    <>
      <button
        className={`bg-transparent text-transparent drop-shadow-2xl text-2xl px-10 py-4 rounded-2xl bg-gradient-to-b from-white/80 to-white/20 text-white dark:text-white border-none ${
